...
"#
    ...
    assert_eq!(
        ...
        Some("custom"),
        "live Codex third-party model_provider should use the Olenro history bucket"
    );
...
fn switch_packycode_gemini_updates_security_selected_type() {
    ...
    // Gemini security settings are written to ~/.gemini/settings.json, not ~/.olenro/settings.json
