//! Deep link import functionality for Olenro
//!
//! This module implements the olenro:// protocol for importing configurations
...
///
/// Represents a parsed olenro:// URL ready for processing.
