...
请只从 **[olenro.com](https://olenro.com)**、**[GitHub Releases](https://github.com/horace68/olenro/releases)** 或项目源码仓库获取 Olenro。任何要求付费、充值或索取登录凭据的“Olenro”网站或客户端都不是官方渠道。
...
1. 访问 [Releases 页面](https://github.com/horace68/olenro/releases)
