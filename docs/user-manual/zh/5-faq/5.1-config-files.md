...
| 字段 | 说明 |
|------|------|
| `models.providers` | 供应商配置（映射为 Olenro 的"供应商"） |
| `env` | 环境变量配置 |
...
- CLI 工具的配置文件（会被 Olenro 回填）
- Olenro 的 `settings.json`
...
Olenro v3.7.0 从 JSON 文件迁移到 SQLite：
