...
Only download Olenro from **[olenro.com](https://olenro.com)**, **[GitHub Releases](https://github.com/lianhr12/olenro/releases)**, or the project source repository. Any "Olenro" site or client that asks for payment, top-ups, or login credentials is not official.
...
1. Visit the [Releases page](https://github.com/lianhr12/olenro/releases)
...
2. Open the DMG, or extract the zip to get `Olenro.app`
...
2. A Olenro icon appears in the system tray
...
- Move `Olenro.app` to Trash
- Optional: Delete the configuration directory `~/.olenro/`
