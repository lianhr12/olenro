...
Only download Olenro from **[olenro.com](https://olenro.com)**, **[GitHub Releases](https://github.com/horace68/olenro/releases)**, or the project source repository. Any "Olenro" site or client that asks for payment, top-ups, or login credentials is not official.
...
1. Visit the [Releases page](https://github.com/horace68/olenro/releases)
