...
Only download Olenro from **[olenro.io](https://olenro.io)**, **[GitHub Releases](https://github.com/lianhr12/olenro/releases)**, or the project source repository. Any "Olenro" site or client that asks for payment, top-ups, or login credentials is not official.
