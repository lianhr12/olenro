...
- **Automatic backup**: Before deletion, the skill is backed up to `~/.olenro/skill-backups/`
- Removes the skill from all app directories (Claude, Codex, Gemini, OpenCode)
- Removes the skill from the SSOT directory (`~/.olenro/skills/`)
...
2. Olenro batch-downloads all skills with pending updates
