...
Olenro provides rich icon customization features:
...
This ensures Olenro and CLI tool configurations stay in sync.
...
When adding a provider, Olenro automatically extracts endpoint URLs from the configuration.
