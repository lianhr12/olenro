...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (Olenro)
...
After starting the proxy and enabling app takeover, Olenro modifies app configurations:
...
When stopping the proxy, Olenro will:
