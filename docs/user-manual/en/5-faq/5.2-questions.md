...
Olenro for macOS is code-signed and notarized by Apple. You can download and install it directly without any additional steps. If you encounter issues, try downloading the latest version from the [Releases page](https://github.com/lianhr12/olenro/releases).
...
1. Visit [GitHub Issues](https://github.com/lianhr12/olenro/issues)
