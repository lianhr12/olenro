...
/**
 * 当 provider 没有自定义图标时，按应用回退到该应用的品牌图标，
 * 使 default 等无图标供应商与官方供应商保持一致的视觉（而非显示首字母）。
 */
const APP_FALLBACK_ICON: Partial<Record<AppId, string>> = {
  claude: "anthropic",
    ...
    >
      ...
      <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-1 items-center gap-2">
          ...
          <div className="h-7 w-7 rounded bg-muted flex items-center justify-center border border-border group-hover:scale-105 transition-transform duration-300 shrink-0">
            <ProviderIcon
              icon={provider.icon || APP_FALLBACK_ICON[appId]}
              name={provider.name}
